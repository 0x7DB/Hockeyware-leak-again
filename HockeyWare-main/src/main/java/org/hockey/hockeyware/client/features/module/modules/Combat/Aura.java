...
public class Aura extends Module {
    ...
    public static final Setting<Boolean> hostileMobs = new Setting<>("HostileMobs", false);
    public static final Setting<Boolean> passiveMobs = new Setting<>("PassiveMobs", false);
    ...
    public Aura() {
        super("Aura", "Automatically Attacks People With Your Sword", Category.Combat);
    }
    ...
    public void attack(Entity entity) {
        if (!getHockey().friendManager.isFriend(entity.getUniqueID())) {
            rotateTo(entity);
            if (weaponsCheck.getValue()) {
                if ((mc.player.getHeldItemMainhand().getItem() == Items.DIAMOND_SWORD) || (mc.player.getHeldItemMainhand().getItem() == Items.IRON_SWORD) || (mc.player.getHeldItemMainhand().getItem() == Items.GOLDEN_SWORD) || (mc.player.getHeldItemMainhand().getItem() == Items.STONE_SWORD) || (mc.player.getHeldItemMainhand().getItem() == Items.WOODEN_SWORD)) {
                    if (delay.getValue()) {
